...
import com.javamastery.repository.BookRepository;
...
public class BookController {
	...
	public ResponseEntity<List<Book>> getBookByTitle(@RequestParam("title") String title) {
		List<Book> bookData = bookRepository.findByTitle(title);
	...
	public ResponseEntity<Book> createBook(@RequestBody Book book) {
		try {
			Book _book = bookRepository.save(new Book(book.getTitle(), book.getDescription(), book.isPublished()));
